...
happening, not to make it non-destructive. That requires a future bootloader
security epoch and a separately tested rollout.
...
1. Implement an anti-rollback security epoch in the bootloader. Nothing in
   this release implements one.
