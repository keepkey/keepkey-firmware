...
TEST(Ripple, AddressEncodeDecode) {
    ...
    EXPECT_TRUE(memcmp(buff, "\x00\x88\xa5\xa5\x7c\x82\x9f\x40\xf2\x5e"
                             "\xa8\x33\x85\xbb\xde\x6c\x3d\x8b\x4c\xa0\x82", 21) == 0);

    char address[56];
    ASSERT_TRUE(ripple_encode_check(buff, 21, HASHER_SHA2D,
    ...
    EXPECT_TRUE(memcmp(addr_raw, "\x00\x88\xa5\xa5\x7c\x82\x9f\x40\xf2\x5e"
                                 "\xa8\x33\x85\xbb\xde\x6c\x3d\x8b\x4c\xa0\x82", 21) == 0);
}
...
TEST(Ripple, SerializeAddress) {
    ...
    EXPECT_TRUE(memcmp(buffer, "\x81\x14\x8f\xb4\x0e\x1f\xfa\x5d\x55\x7c\xe9"
                               "\x85\x1a\x53\x5a\xf9\x49\x65\xe0\xdd\x09\x88", 22) == 0);
}
