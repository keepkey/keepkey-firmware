...
TEST(Storage, StorageRoundTrip) {
  ...
  start.storage.pub.fw_version_major = 0x12;
  start.storage.pub.fw_version_minor = 0x34;
  start.storage.pub.fw_version_patch = 0x56;
  ...
  const uint8_t expected_flash[] = {
      ...
      0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab,
      0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0xab, 0x12, 0x34, 0x56,
