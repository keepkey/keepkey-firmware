...
typedef enum _MessageType {
    ...
    MessageType_MessageType_FirmwareUpdate = 7,
    ...
    MessageType_MessageType_KeepKeyBootloaderFrame = 48,
    MessageType_MessageType_LAST = 49
} MessageType;
...
typedef struct {
    size_t size;
    uint8_t bytes[48];
} FirmwareUpdate_payload_t;

typedef struct _FirmwareUpdate {
    bool has_final;
    bool final;
    uint32_t offset;
    FirmwareUpdate_payload_t payload;
} FirmwareUpdate;
...
typedef struct _KeepKeyBootloaderFrame {
    MessageType type;
    bool has_initialize;
    ...
    bool has_failure;
    Failure failure;
    bool has_passphrase_request;
    PassphraseRequest passphrase_request;
    bool has_passphrase_ack;
    PassphraseAck passphrase_ack;
    bool has_firmware_update;
    FirmwareUpdate firmware_update;
} KeepKeyBootloaderFrame;
...
#define FirmwareUpdate_final_tag                 1
#define FirmwareUpdate_offset_tag                2
#define FirmwareUpdate_payload_tag               3
...
#define KeepKeyBootloaderFrame_type_tag          1
#define KeepKeyBootloaderFrame_initialize_tag    2
#define KeepKeyBootloaderFrame_ping_tag          3
#define KeepKeyBootloaderFrame_success_tag       4
#define KeepKeyBootloaderFrame_failure_tag       5
#define KeepKeyBootloaderFrame_passphrase_request_tag 6
#define KeepKeyBootloaderFrame_passphrase_ack_tag 7
#define KeepKeyBootloaderFrame_firmware_update_tag 8
...
extern const pb_field_t FirmwareUpdate_fields[4];
extern const pb_field_t KeepKeyBootloaderFrame_fields[9];
...
#define FirmwareUpdate_size                      58
#define KeepKeyBootloaderFrame_size              923
