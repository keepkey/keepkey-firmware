...
/* Generated by nanopb-0.2.8 at Wed Jun 11 16:39:51 2014. */
...
const pb_field_t FirmwareUpdate_fields[4] = {
    PB_FIELD2(  1, BOOL    , OPTIONAL, STATIC  , FIRST, FirmwareUpdate, final, final, 0),
    PB_FIELD2(  2, UINT32  , REQUIRED, STATIC  , OTHER, FirmwareUpdate, offset, final, 0),
    PB_FIELD2(  3, BYTES   , REQUIRED, STATIC  , OTHER, FirmwareUpdate, payload, offset, 0),
    PB_LAST_FIELD
};

const pb_field_t KeepKeyBootloaderFrame_fields[9] = {
    PB_FIELD2(  1, ENUM    , REQUIRED, STATIC  , FIRST, KeepKeyBootloaderFrame, type, type, 0),
    PB_FIELD2(  2, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, initialize, type, &Initialize_fields),
    PB_FIELD2(  3, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, ping, initialize, &Ping_fields),
    PB_FIELD2(  4, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, success, ping, &Success_fields),
    PB_FIELD2(  5, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, failure, success, &Failure_fields),
    PB_FIELD2(  6, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, passphrase_request, failure, &PassphraseRequest_fields),
    PB_FIELD2(  7, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, passphrase_ack, passphrase_request, &PassphraseAck_fields),
    PB_FIELD2(  8, MESSAGE , OPTIONAL, STATIC  , OTHER, KeepKeyBootloaderFrame, firmware_update, passphrase_ack, &FirmwareUpdate_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(KeepKeyBootloaderFrame, initialize) < 65536 && pb_membersize(KeepKeyBootloaderFrame, ping) < 65536 && pb_membersize(KeepKeyBootloaderFrame, success) < 65536 && pb_membersize(KeepKeyBootloaderFrame, failure) < 65536 && pb_membersize(KeepKeyBootloaderFrame, passphrase_request) < 65536 && pb_membersize(KeepKeyBootloaderFrame, passphrase_ack) < 65536 && pb_membersize(KeepKeyBootloaderFrame, firmware_update) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_Features_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_SignMessage_VerifyMessage_MessageSignature_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_FirmwareUpdate_KeepKeyBootloaderFrame)
#endif
