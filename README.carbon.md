...
1.1 https://www.nordicsemi.com/eng/nordic/download_resource/22748/3/4972989 
1.1.1 Eclipse update site: http://embsysregview.sourceforge.net/update
...
1. Build opencm3
1.1 cd libopencm3 && make

1. Generate protobufs
1.1 cd interface && ./build_protos.sh

1. Run setup.sh to setup some environment variables.

1. To build:
1.1 Build debug version: ./b -s -d 
1.1 Build release version: ./b -s
