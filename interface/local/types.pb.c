...
const char ExchangeType_deposit_coin_name_default[17] = "Bitcoin";
const char ExchangeType_return_coin_name_default[17] = "Bitcoin";
...
const pb_field_t ExchangeType_fields[7] = {
    PB_FIELD2(  1, MESSAGE , OPTIONAL, STATIC  , FIRST, ExchangeType, response, response, &ExchangeResponse_fields),
    PB_FIELD2(  2, STRING  , OPTIONAL, STATIC  , OTHER, ExchangeType, deposit_coin_name, response, &ExchangeType_deposit_coin_name_default),
    PB_FIELD2(  3, STRING  , OPTIONAL, STATIC  , OTHER, ExchangeType, deposit_address, deposit_coin_name, 0),
    PB_FIELD2(  4, UINT32  , REPEATED, STATIC  , OTHER, ExchangeType, deposit_address_n, deposit_address, 0),
    PB_FIELD2(  5, STRING  , OPTIONAL, STATIC  , OTHER, ExchangeType, return_coin_name, deposit_address_n, &ExchangeType_return_coin_name_default),
    PB_FIELD2(  6, UINT32  , REPEATED, STATIC  , OTHER, ExchangeType, return_address_n, return_coin_name, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(HDNodePathType, node) < 65536 && pb_membersize(MultisigRedeemScriptType, pubkeys[0]) < 65536 && pb_membersize(TxInputType, multisig) < 65536 && pb_membersize(TxOutputType, multisig) < 65536 && pb_membersize(TxOutputType, exchange_type) < 65536 && pb_membersize(TransactionType, inputs[0]) < 65536 && pb_membersize(TransactionType, bin_outputs[0]) < 65536 && pb_membersize(TransactionType, outputs[0]) < 65536 && pb_membersize(ExchangeType, response) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_HDNodeType_HDNodePathType_CoinType_MultisigRedeemScriptType_TxInputType_TxOutputType_TxOutputBinType_TransactionType_RawTransactionType_TxRequestDetailsType_TxRequestSerializedType_IdentityType_PolicyType_ExchangeType)
#endif
