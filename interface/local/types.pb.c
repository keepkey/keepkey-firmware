...
const pb_field_t CoinType_fields[13] = {
    ...
    PB_FIELD2(  9, UINT32  , OPTIONAL, STATIC  , OTHER, CoinType, bip44_account_path, signed_message_header, 0),
    PB_FIELD2( 12, UINT32  , OPTIONAL, STATIC  , OTHER, CoinType, forkid, bip44_account_path, 0),
    PB_FIELD2( 13, UINT32  , OPTIONAL, STATIC  , OTHER, CoinType, decimals, forkid, 0),
    PB_FIELD2( 14, STRING  , OPTIONAL, STATIC  , OTHER, CoinType, contract_address, decimals, 0),
    PB_LAST_FIELD
};
...
const pb_field_t TxOutputType_fields[9] = {
    ...
    PB_FIELD2(  8, MESSAGE , OPTIONAL, STATIC  , OTHER, TxOutputType, exchange_type, address_type, &ExchangeType_fields),
    PB_LAST_FIELD
};
...
const pb_field_t TransactionType_fields[10] = {
    ...
    PB_FIELD2(  8, BYTES   , OPTIONAL, CALLBACK, OTHER, TransactionType, extra_data, outputs_cnt, 0),
...
const pb_field_t RawTransactionType_fields[2] = {
    PB_FIELD2(  1, BYTES   , REQUIRED, STATIC  , FIRST, RawTransactionType, payload, payload, 0),
    PB_LAST_FIELD
};
...
const pb_field_t PolicyType_fields[3] = {
    PB_FIELD2(  1, STRING  , OPTIONAL, STATIC  , FIRST, PolicyType, policy_name, policy_name, 0),
    PB_FIELD2(  2, BOOL    , OPTIONAL, STATIC  , OTHER, PolicyType, enabled, policy_name, 0),
    PB_LAST_FIELD
};

const pb_field_t ExchangeType_fields[5] = {
    PB_FIELD2(  1, MESSAGE , OPTIONAL, STATIC  , FIRST, ExchangeType, signed_exchange_response, signed_exchange_response, &SignedExchangeResponse_fields),
    PB_FIELD2(  2, STRING  , OPTIONAL, STATIC  , OTHER, ExchangeType, withdrawal_coin_name, signed_exchange_response, &ExchangeType_withdrawal_coin_name_default),
    PB_FIELD2(  3, UINT32  , REPEATED, STATIC  , OTHER, ExchangeType, withdrawal_address_n, withdrawal_coin_name, 0),
    PB_FIELD2(  4, UINT32  , REPEATED, STATIC  , OTHER, ExchangeType, return_address_n, withdrawal_address_n, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(HDNodePathType, node) < 65536 && pb_membersize(MultisigRedeemScriptType, pubkeys[0]) < 65536 && pb_membersize(TxInputType, multisig) < 65536 && pb_membersize(TxOutputType, multisig) < 65536 && pb_membersize(TxOutputType, exchange_type) < 65536 && pb_membersize(TransactionType, inputs[0]) < 65536 && pb_membersize(TransactionType, bin_outputs[0]) < 65536 && pb_membersize(TransactionType, outputs[0]) < 65536 && pb_membersize(ExchangeType, signed_exchange_response) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_HDNodeType_HDNodePathType_CoinType_MultisigRedeemScriptType_TxInputType_TxOutputType_TxOutputBinType_TransactionType_RawTransactionType_TxRequestDetailsType_TxRequestSerializedType_IdentityType_PolicyType_ExchangeType)
#endif
