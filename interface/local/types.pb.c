...
const NetworkType CoinType_network_type_default = NetworkType_BITCOIN;
...
const pb_field_t CoinType_fields[7] = {
    ...
    PB_FIELD2(  6, ENUM    , OPTIONAL, STATIC  , OTHER, CoinType, network_type, address_type_p2sh, &CoinType_network_type_default),
    PB_LAST_FIELD
};
