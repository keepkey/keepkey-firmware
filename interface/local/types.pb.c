...
const pb_field_t Exchange_Address_fields[4] = {
    PB_FIELD2(  1, STRING  , OPTIONAL, CALLBACK, FIRST, Exchange_Address, address, address, 0),
    PB_FIELD2(  2, STRING  , OPTIONAL, CALLBACK, OTHER, Exchange_Address, dest_tag, address, 0),
    PB_FIELD2(  3, STRING  , OPTIONAL, CALLBACK, OTHER, Exchange_Address, rs_address, dest_tag, 0),
    PB_LAST_FIELD
};
...
const pb_field_t SendAmountRequest_fields[7] = {
    ...
    PB_FIELD2(  3, STRING  , OPTIONAL, CALLBACK, OTHER, SendAmountRequest, withdrawal_coin_type, withdrawal_address, 0),
    PB_FIELD2(  4, STRING  , OPTIONAL, CALLBACK, OTHER, SendAmountRequest, deposit_coin_type, withdrawal_coin_type, 0),
    PB_FIELD2(  5, MESSAGE , OPTIONAL, STATIC  , OTHER, SendAmountRequest, return_address, deposit_coin_type, &Exchange_Address_fields),
    PB_FIELD2(  6, BYTES   , OPTIONAL, CALLBACK, OTHER, SendAmountRequest, api_key, return_address, 0),
    PB_LAST_FIELD
};

const pb_field_t SendAmountResponse_fields[7] = {
    PB_FIELD2(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, SendAmountResponse, signature, signature, 0),
    PB_FIELD2(  2, MESSAGE , OPTIONAL, STATIC  , OTHER, SendAmountResponse, request, signature, &SendAmountRequest_fields),
    PB_FIELD2(  3, MESSAGE , OPTIONAL, STATIC  , OTHER, SendAmountResponse, deposit_address, request, &Exchange_Address_fields),
    PB_FIELD2(  4, UINT64  , OPTIONAL, STATIC  , OTHER, SendAmountResponse, deposit_amount, deposit_address, 0),
    PB_FIELD2(  5, UINT32  , OPTIONAL, STATIC  , OTHER, SendAmountResponse, expiration, deposit_amount, 0),
    PB_FIELD2(  6, UINT32  , OPTIONAL, STATIC  , OTHER, SendAmountResponse, quoted_rate, expiration, 0),
    PB_LAST_FIELD
};
...
const pb_field_t TxOutputType_fields[9] = {
    ...
    PB_FIELD2(  8, MESSAGE , OPTIONAL, STATIC  , OTHER, TxOutputType, exchange_token, address_type, &SendAmountResponse_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(HDNodePathType, node) < 65536 && pb_membersize(MultisigRedeemScriptType, pubkeys[0]) < 65536 && pb_membersize(TxInputType, multisig) < 65536 && pb_membersize(SendAmountRequest, withdrawal_address) < 65536 && pb_membersize(SendAmountRequest, return_address) < 65536 && pb_membersize(SendAmountResponse, request) < 65536 && pb_membersize(SendAmountResponse, deposit_address) < 65536 && pb_membersize(TxOutputType, multisig) < 65536 && pb_membersize(TxOutputType, exchange_token) < 65536 && pb_membersize(TransactionType, inputs[0]) < 65536 && pb_membersize(TransactionType, bin_outputs[0]) < 65536 && pb_membersize(TransactionType, outputs[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_HDNodeType_HDNodePathType_CoinType_MultisigRedeemScriptType_TxInputType_Exchange_Address_SendAmountRequest_SendAmountResponse_TxOutputType_TxOutputBinType_TransactionType_TxRequestDetailsType_TxRequestSerializedType_IdentityType)
#endif
