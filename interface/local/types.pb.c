...
const pb_field_t ExchangeType_fields[6] = {
    ...
    PB_FIELD2(  3, UINT32  , REPEATED, STATIC  , OTHER, ExchangeType, deposit_address_n, deposit_coin_name, 0),
    PB_FIELD2(  4, STRING  , OPTIONAL, STATIC  , OTHER, ExchangeType, return_coin_name, deposit_address_n, &ExchangeType_return_coin_name_default),
    PB_FIELD2(  5, UINT32  , REPEATED, STATIC  , OTHER, ExchangeType, return_address_n, return_coin_name, 0),
    PB_LAST_FIELD
};
