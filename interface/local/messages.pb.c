...
/* Generated by nanopb-0.2.9.2 at Mon May 18 21:52:09 2015. */
...
const pb_field_t FirmwareUpload_fields[3] = {
    PB_FIELD2(  1, BYTES   , REQUIRED, CALLBACK, FIRST, FirmwareUpload, payload_crc, payload_crc, 0),
    PB_FIELD2(  2, BYTES   , REQUIRED, STATIC  , OTHER, FirmwareUpload, payload, payload_crc, 0),
    PB_LAST_FIELD
};
...
const pb_field_t DebugLinkState_fields[15] = {
    ...
    PB_FIELD2( 13, BYTES   , OPTIONAL, STATIC  , OTHER, DebugLinkState, app_fingerprint, recovery_auto_completed_word, 0),
    PB_FIELD2( 14, BYTES   , OPTIONAL, STATIC  , OTHER, DebugLinkState, storage_fingerprint, app_fingerprint, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_CharacterRequest_CharacterAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_SignIdentity_SignedIdentity_FirmwareErase_FirmwareUpload_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog)
#endif
