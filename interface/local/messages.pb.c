...
/* Generated by nanopb-0.2.9 at Mon Dec  1 19:55:38 2014. */
...
const pb_field_t EncryptedMessage_fields[4] = {
    PB_FIELD2(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, EncryptedMessage, nonce, nonce, 0),
    PB_FIELD2(  2, BYTES   , OPTIONAL, CALLBACK, OTHER, EncryptedMessage, message, nonce, 0),
    PB_FIELD2(  3, BYTES   , OPTIONAL, CALLBACK, OTHER, EncryptedMessage, hmac, message, 0),
    PB_LAST_FIELD
};

const pb_field_t DecryptMessage_fields[5] = {
    PB_FIELD2(  1, UINT32  , REPEATED, STATIC  , FIRST, DecryptMessage, address_n, address_n, 0),
    PB_FIELD2(  2, BYTES   , OPTIONAL, CALLBACK, OTHER, DecryptMessage, nonce, address_n, 0),
    PB_FIELD2(  3, BYTES   , OPTIONAL, STATIC  , OTHER, DecryptMessage, message, nonce, 0),
    PB_FIELD2(  4, BYTES   , OPTIONAL, CALLBACK, OTHER, DecryptMessage, hmac, message, 0),
    PB_LAST_FIELD
};

const pb_field_t DecryptedMessage_fields[3] = {
    PB_FIELD2(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, DecryptedMessage, message, message, 0),
    PB_FIELD2(  2, STRING  , OPTIONAL, CALLBACK, OTHER, DecryptedMessage, address, message, 0),
    PB_LAST_FIELD
};
...
const pb_field_t CipheredKeyValue_fields[2] = {
    PB_FIELD2(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, CipheredKeyValue, value, value, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_FirmwareErase_FirmwareUpload)
#endif
