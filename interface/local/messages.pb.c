...
const pb_field_t RecoveryDevice_fields[8] = {
    ...
    PB_FIELD2(  7, BOOL    , OPTIONAL, STATIC  , OTHER, RecoveryDevice, use_character_cypher, enforce_wordlist, 0),
    PB_LAST_FIELD
};
...
const pb_field_t CharacterRequest_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t CharacterAck_fields[2] = {
    PB_FIELD2(  1, STRING  , REQUIRED, STATIC  , FIRST, CharacterAck, character, character, 0),
    PB_LAST_FIELD
};

const pb_field_t CharacterDeleteAck_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t CharacterFinalAck_fields[1] = {
    PB_LAST_FIELD
};
...
const pb_field_t DebugLinkState_fields[13] = {
    ...
    PB_FIELD2( 11, UINT32  , OPTIONAL, STATIC  , OTHER, DebugLinkState, config_stor_count, recovery_word_pos, 0),
    PB_FIELD2( 12, BYTES   , OPTIONAL, STATIC  , OTHER, DebugLinkState, config_stor, config_stor_count, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_CharacterRequest_CharacterAck_CharacterDeleteAck_CharacterFinalAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_FirmwareErase_FirmwareUpload_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog)
#endif
