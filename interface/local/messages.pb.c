...
const pb_field_t GetPublicKey_fields[4] = {
    ...
    PB_FIELD2(  2, BOOL    , OPTIONAL, STATIC  , OTHER, GetPublicKey, show_display, address_n, 0),
    PB_FIELD2(  3, STRING  , OPTIONAL, STATIC  , OTHER, GetPublicKey, ecdsa_curve_name, show_display, 0),
    PB_LAST_FIELD
};
