...
const pb_field_t Features_fields[20] = {
    ...
    PB_FIELD2( 18, MESSAGE , REPEATED, STATIC  , OTHER, Features, policies, passphrase_cached, &PolicyType_fields),
    PB_FIELD2( 21, STRING  , OPTIONAL, STATIC  , OTHER, Features, model, policies, 0),
    PB_LAST_FIELD
};
...
const pb_field_t RawTxAck_fields[2] = {
    PB_FIELD2(  1, MESSAGE , OPTIONAL, STATIC  , FIRST, RawTxAck, tx, tx, &RawTransactionType_fields),
    PB_LAST_FIELD
};

const pb_field_t EthereumSignTx_fields[16] = {
    ...
    PB_FIELD2(  9, UINT32  , REPEATED, STATIC  , OTHER, EthereumSignTx, to_address_n, data_length, 0),
    PB_FIELD2( 10, ENUM    , OPTIONAL, STATIC  , OTHER, EthereumSignTx, address_type, to_address_n, 0),
    PB_FIELD2( 11, MESSAGE , OPTIONAL, STATIC  , OTHER, EthereumSignTx, exchange_type, address_type, &ExchangeType_fields),
    PB_FIELD2( 12, UINT32  , OPTIONAL, STATIC  , OTHER, EthereumSignTx, chain_id, exchange_type, 0),
    PB_FIELD2(100, BYTES   , OPTIONAL, STATIC  , OTHER, EthereumSignTx, token_value, chain_id, 0),
    PB_FIELD2(101, BYTES   , OPTIONAL, STATIC  , OTHER, EthereumSignTx, token_to, token_value, 0),
    PB_FIELD2(102, STRING  , OPTIONAL, STATIC  , OTHER, EthereumSignTx, token_shortcut, token_to, 0),
    PB_LAST_FIELD
};
...
const pb_field_t EthereumTxRequest_fields[7] = {
    ...
    PB_FIELD2(  5, BYTES   , OPTIONAL, STATIC  , OTHER, EthereumTxRequest, hash, signature_s, 0),
    PB_FIELD2(  6, BYTES   , OPTIONAL, STATIC  , OTHER, EthereumTxRequest, signature_der, hash, 0),
    PB_LAST_FIELD
};
...
const pb_field_t ApplyPolicies_fields[2] = {
    PB_FIELD2(  1, MESSAGE , REPEATED, STATIC  , FIRST, ApplyPolicies, policy, policy, &PolicyType_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(Features, policies[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(RawTxAck, tx) < 65536 && pb_membersize(EthereumSignTx, exchange_type) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(ApplyPolicies, policy[0]) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_EthereumGetAddress_Address_EthereumAddress_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_CharacterRequest_CharacterAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_RawTxAck_EthereumSignTx_EthereumTxRequest_EthereumTxAck_SignIdentity_SignedIdentity_ApplyPolicies_FirmwareErase_FirmwareUpload_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog_DebugLinkFillConfig)
#endif
