...
/* Generated by nanopb-0.2.9.2 at Mon Apr 20 21:36:13 2015. */
...
const pb_field_t CharacterRequest_fields[2] = {
    PB_FIELD2(  2, BOOL    , OPTIONAL, STATIC  , FIRST, CharacterRequest, found, found, 0),
    PB_LAST_FIELD
};
