...
const pb_field_t Storage_fields[11] = {
    ...
    PB_FIELD2( 10, MESSAGE , REPEATED, STATIC  , OTHER, Storage, policies, imported, &PolicyType_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Storage, node) < 65536 && pb_membersize(Storage, policies[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Storage)
#endif
 ...
 * 8 bit descriptors.
 */
STATIC_ASSERT((pb_membersize(Storage, node) < 256 && pb_membersize(Storage, policies[0]) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Storage)
#endif
