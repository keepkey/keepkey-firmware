...
/* Generated by nanopb-0.2.9.1 at Tue Feb 17 00:00:43 2015. */
...
const pb_field_t SecondaryStorage_fields[2] = {
    PB_FIELD2(  5, UINT32  , OPTIONAL, STATIC  , FIRST, SecondaryStorage, pin_failed_attempts, pin_failed_attempts, 0),
    PB_LAST_FIELD
};

const pb_field_t Cache_fields[2] = {
    PB_FIELD2(  1, MESSAGE , OPTIONAL, STATIC  , FIRST, Cache, root_node, root_node, &HDNodeType_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Storage, node) < 65536 && pb_membersize(Cache, root_node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Storage_SecondaryStorage_Cache)
#endif
 ...
 * 8 bit descriptors.
 */
STATIC_ASSERT((pb_membersize(Storage, node) < 256 && pb_membersize(Cache, root_node) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Storage_SecondaryStorage_Cache)
#endif
