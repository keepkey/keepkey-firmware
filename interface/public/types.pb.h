...
/* Generated by nanopb-0.2.9.2 at Fri May 20 19:17:52 2016. */
...
typedef enum _ButtonRequestType {
    ...
    ButtonRequestType_ButtonRequest_SignTx = 7,
    ButtonRequestType_ButtonRequest_FirmwareCheck = 8,
    ButtonRequestType_ButtonRequest_Address = 9,
    ButtonRequestType_ButtonRequest_FirmwareErase = 10,
    ButtonRequestType_ButtonRequest_ConfirmTransferToAccount = 11,
    ButtonRequestType_ButtonRequest_ConfirmTransferToNodePath = 12,
    ButtonRequestType_ButtonRequest_ChangeLabel = 13,
    ButtonRequestType_ButtonRequest_ChangeLanguage = 14,
    ButtonRequestType_ButtonRequest_EnablePassphrase = 15,
    ButtonRequestType_ButtonRequest_DisablePassphrase = 16,
    ButtonRequestType_ButtonRequest_EncryptAndSignMessage = 17,
    ButtonRequestType_ButtonRequest_EncryptMessage = 18,
    ButtonRequestType_ButtonRequest_ImportPrivateKey = 19,
    ButtonRequestType_ButtonRequest_ImportRecoverySentence = 20,
    ButtonRequestType_ButtonRequest_signIdentity = 21,
    ButtonRequestType_ButtonRequest_Ping = 22,
    ButtonRequestType_ButtonRequest_RemovePIN = 23,
    ButtonRequestType_ButtonRequest_ChangePIN = 24,
    ButtonRequestType_ButtonRequest_CreatePIN = 25,
    ButtonRequestType_ButtonRequest_GenerateEntropy = 26,
    ButtonRequestType_ButtonRequest_SignMessage = 27
} ButtonRequestType;
