...
/* Generated by nanopb-0.2.9.2 at Fri Jun  3 17:17:33 2016. */
...
typedef struct _Exchange_Address {
    ...
    pb_callback_t dest_tag;
    pb_callback_t rs_address;
} Exchange_Address;
...
typedef struct _SendAmountRequest {
    ...
    pb_callback_t withdrawal_coin_type;
    pb_callback_t deposit_coin_type;
...
#define Exchange_Address_init_default            {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define SendAmountRequest_init_default           {false, 0, false, Exchange_Address_init_default, {{NULL}, NULL}, {{NULL}, NULL}, false, Exchange_Address_init_default, {{NULL}, NULL}}
#define SendAmountResponse_init_default          {{{NULL}, NULL}, false, SendAmountRequest_init_default, false, Exchange_Address_init_default, false, 0, false, 0, false, 0}
...
#define Exchange_Address_init_zero               {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define SendAmountRequest_init_zero              {false, 0, false, Exchange_Address_init_zero, {{NULL}, NULL}, {{NULL}, NULL}, false, Exchange_Address_init_zero, {{NULL}, NULL}}
#define SendAmountResponse_init_zero             {{{NULL}, NULL}, false, SendAmountRequest_init_zero, false, Exchange_Address_init_zero, false, 0, false, 0, false, 0}
