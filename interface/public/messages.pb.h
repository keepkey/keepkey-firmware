...
typedef struct {
    size_t size;
    uint8_t bytes[32];
} DebugLinkState_storage_fingerprint_t;
...
typedef struct _DebugLinkState {
    ...
    bool has_storage_fingerprint;
    DebugLinkState_storage_fingerprint_t storage_fingerprint;
} DebugLinkState;
...
#define FirmwareUpload_init_default              {{{NULL}, NULL}, {0, {0}}}
...
#define FirmwareUpload_init_zero                 {{{NULL}, NULL}, {0, {0}}}
...
#define DebugLinkState_storage_fingerprint_tag   14
...
#define FirmwareUpload_payload_crc_tag           1
