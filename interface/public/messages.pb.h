...
typedef enum _MessageType {
    MessageType_MessageType_Initialize = 1,
    MessageType_MessageType_Ping = 2,
    MessageType_MessageType_Success = 3,
    MessageType_MessageType_Failure = 4,
    MessageType_MessageType_ChangePin = 5,
    MessageType_MessageType_WipeDevice = 6,
    ...
    MessageType_MessageType_FirmwareUpload = 48,
    MessageType_MessageType_FirmwareErase = 49
} MessageType;
...
#define Features_init_default                    {false, "", false, 0, false, 0, false, 0, false, 0, false, "", false, 0, false, 0, false, "", false, "", 0, {CoinType_init_default, CoinType_init_default, CoinType_init_default, CoinType_init_default}, false, 0, false, {0, {0}}, false, {0, {0}}}
...
#define PublicKey_init_default                   {HDNodeType_init_default}
#define GetAddress_init_default                  {0, {0, 0, 0, 0, 0, 0, 0, 0}, false, "Bitcoin"}
...
#define SimpleSignTx_init_default                {0, {TxInputType_init_default, TxInputType_init_default, TxInputType_init_default, TxInputType_init_default}, 0, {TxOutputType_init_default, TxOutputType_init_default, TxOutputType_init_default, TxOutputType_init_default}, 0, {TransactionType_init_default, TransactionType_init_default, TransactionType_init_default, TransactionType_init_default}, false, "Bitcoin"}
...
#define Features_init_zero                       {false, "", false, 0, false, 0, false, 0, false, 0, false, "", false, 0, false, 0, false, "", false, "", 0, {CoinType_init_zero, CoinType_init_zero, CoinType_init_zero, CoinType_init_zero}, false, 0, false, {0, {0}}, false, {0, {0}}}
...
#define PublicKey_init_zero                      {HDNodeType_init_zero}
#define GetAddress_init_zero                     {0, {0, 0, 0, 0, 0, 0, 0, 0}, false, ""}
...
#define SimpleSignTx_init_zero                   {0, {TxInputType_init_zero, TxInputType_init_zero, TxInputType_init_zero, TxInputType_init_zero}, 0, {TxOutputType_init_zero, TxOutputType_init_zero, TxOutputType_init_zero, TxOutputType_init_zero}, 0, {TransactionType_init_zero, TransactionType_init_zero, TransactionType_init_zero, TransactionType_init_zero}, false, ""}
