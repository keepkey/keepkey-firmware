...
typedef struct {
    size_t size;
    uint8_t bytes[32];
} DebugLinkState_app_fingerprint_t;
...
typedef struct _DebugLinkState {
    ...
    bool has_app_fingerprint;
    DebugLinkState_app_fingerprint_t app_fingerprint;
} DebugLinkState;
...
#define DebugLinkState_init_default              {false, {0, {0}}, false, "", false, "", false, "", false, HDNodeType_init_default, false, 0, false, "", false, {0, {0}}, false, "", false, 0, false, "", false, "", false, {0, {0}}}
...
#define DebugLinkState_init_zero                 {false, {0, {0}}, false, "", false, "", false, "", false, HDNodeType_init_zero, false, 0, false, "", false, {0, {0}}, false, "", false, 0, false, "", false, "", false, {0, {0}}}
...
#define DebugLinkState_app_fingerprint_tag       13
...
extern const pb_field_t DebugLinkState_fields[14];
...
#define DebugLinkState_size                      (1667 + HDNodeType_size)
