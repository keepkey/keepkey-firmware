...
/* Generated by nanopb-0.2.9.1 at Mon Mar 30 23:42:33 2015. */
...
typedef enum _MessageType {
    ...
    MessageType_MessageType_CharacterRequest = 53,
    MessageType_MessageType_CharacterAck = 54,
    MessageType_MessageType_CharacterDeleteAck = 55,
    MessageType_MessageType_CharacterFinalAck = 56,
...
typedef struct _CharacterDeleteAck {
    uint8_t dummy_field;
} CharacterDeleteAck;

typedef struct _CharacterFinalAck {
    uint8_t dummy_field;
} CharacterFinalAck;
...
typedef struct _DebugLinkState {
    ...
    bool has_config_stor_count;
    uint32_t config_stor_count;
    bool has_config_stor;
    DebugLinkState_config_stor_t config_stor;
} DebugLinkState;
...
typedef struct _RecoveryDevice {
    ...
    bool has_use_character_cypher;
    bool use_character_cypher;
} RecoveryDevice;
...
#define CharacterRequest_init_default            {0}
#define CharacterAck_init_default                {""}
#define CharacterDeleteAck_init_default          {0}
#define CharacterFinalAck_init_default           {0}
...
#define DebugLinkState_init_default              {false, {0, {0}}, false, "", false, "", false, "", false, HDNodeType_init_default, false, 0, false, "", false, {0, {0}}, false, "", false, 0, false, 0, false, {0, {0}}}
...
#define CharacterRequest_init_zero               {0}
#define CharacterAck_init_zero                   {""}
#define CharacterDeleteAck_init_zero             {0}
#define CharacterFinalAck_init_zero              {0}
...
#define DebugLinkState_init_zero                 {false, {0, {0}}, false, "", false, "", false, "", false, HDNodeType_init_zero, false, 0, false, "", false, {0, {0}}, false, "", false, 0, false, 0, false, {0, {0}}}
...
#define DebugLinkState_config_stor_count_tag     11
#define DebugLinkState_config_stor_tag           12
...
#define RecoveryDevice_use_character_cypher_tag  7
...
extern const pb_field_t CharacterRequest_fields[1];
extern const pb_field_t CharacterAck_fields[2];
extern const pb_field_t CharacterDeleteAck_fields[1];
extern const pb_field_t CharacterFinalAck_fields[1];
...
#define CharacterRequest_size                    0
#define CharacterAck_size                        4
#define CharacterDeleteAck_size                  0
#define CharacterFinalAck_size                   0
...
#define DebugLinkState_size                      (2103 + HDNodeType_size)
