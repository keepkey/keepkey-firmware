...
typedef struct _Cache {
    bool has_root_node;
    HDNodeType root_node;
} Cache;

typedef struct _SecondaryStorage {
...
#define SecondaryStorage_init_default            {false, 0}
#define Cache_init_default                       {false, HDNodeType_init_default}
#define Storage_init_zero                        {0, false, HDNodeType_init_zero, false, "", false, 0, false, 0, false, "", false, "", false, "", false, 0}
#define SecondaryStorage_init_zero               {false, 0}
#define Cache_init_zero                          {false, HDNodeType_init_zero}

/* Field tags (for use in manual encoding/decoding) */
#define Cache_root_node_tag                      1
#define SecondaryStorage_pin_failed_attempts_tag 5
...
extern const pb_field_t SecondaryStorage_fields[2];
extern const pb_field_t Cache_fields[2];

/* Maximum encoded size of messages (where known) */
#define Storage_size                             (332 + HDNodeType_size)
#define SecondaryStorage_size                    6
#define Cache_size                               (6 + HDNodeType_size)
