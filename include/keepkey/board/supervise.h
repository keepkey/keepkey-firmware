...
#define SVC_FIRMWARE_UNPRIV \
  9  // WARNING: do not change this value unless you also change
     // svc_firmware_unpriv in isr.s to match
 ...
 * exit:
 *	    requested sector is erased if legal: note that bootstrap and
 *bootloader sectors cannot be erased with this call.
 **/
...
/**
    ...
    on entry:
        ...
        svc calls to erase and write the flash should not be done in bootloader,
use direct erase and write functions
**/
...
/**
   ...
   On entry:
        ...
        on exit:
         ...
         svc calls to erase and write the flash should not be done in
   bootloader, use direct erase and write functions
*/
