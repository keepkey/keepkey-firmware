...
/**
  * @brief  Power OFF function: handles switch-off conditions.
  * @param  None
  * @retval USB_SUCCESS.
  */
RESULT PowerOff()
...
/**
  ...
  *         interrupt calling this subroutine
  * @param  a state machine value (RESUME_STATE)
  *          RESUME_ESOF doesn't change ResumeS.eState allowing decrementing of 
  *          the ESOF counter in different states.
  * @retval None.
  */
