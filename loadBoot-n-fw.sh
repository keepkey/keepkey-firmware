...
openocd -s /usr/share/openocd/scripts -f /usr/share/openocd/scripts/interface/jlink.cfg -f /usr/share/openocd/scripts/board/keepkey_board.cfg -c "program $ELF_FILE verify"
if [[ $? -ne 0 ]]; then
	echo $?
...
openocd -s /usr/share/openocd/scripts -f interface/jlink.cfg -f /usr/share/openocd/scripts/board/keepkey_board.cfg -c "program $ELF_FILE verify"
if [[ $? -ne 0 ]]; then
	echo $?
