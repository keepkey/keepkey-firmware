...
#define FLASH_CONFIG_LEN	(0x8000)

#define FLASH_APP_START		(FLASH_CONFIG_START + FLASH_CONFIG_LEN)

#define FLASH_CONFIG_MAGIC	(FLASH_CONFIG_START)
#define FLASH_CONFIG_CODELEN	(FLASH_CONFIG_START + 0x0004)
#define FLASH_CONFIG_SIGINDEX1	(FLASH_CONFIG_START + 0x0008)
#define FLASH_CONFIG_SIGINDEX2	(FLASH_CONFIG_START + 0x0009)
#define FLASH_CONFIG_SIGINDEX3	(FLASH_CONFIG_START + 0x000A)
#define FLASH_CONFIG_FLAGS	(FLASH_CONFIG_START + 0x000B)
#define FLASH_CONFIG_SIG1	(FLASH_CONFIG_START + 0x0040)
#define FLASH_CONFIG_SIG2	(FLASH_CONFIG_START + 0x0080)
#define FLASH_CONFIG_SIG3	(FLASH_CONFIG_START + 0x00C0)
...
#define FLASH_CONFIG_SECTOR_FIRST	4
#define FLASH_CONFIG_SECTOR_LAST	4

#define FLASH_APP_SECTOR_FIRST	5
...
static const FlashSector flash_sector_map[FLASH_APP_SECTOR_LAST+2] = {
    ...
    { 3,  0x0800c000, 0x4000,  FLASH_CONFIG },
    { 4,  0x08010000, 0x10000, FLASH_APP },
    { 5,  0x08020000, 0x20000, FLASH_APP },
